...
public class Test04 {
    public static void main(String[] args) {
        ...
        e.desistement(new Candidat("","PANCOLET ALEXANDRE 0"),cmp);
        if (!e.estCorrecte()) TC.println("ERREUR: liste incorrecte apres un desistement");
        e.desistement(new Candidat("", "DANCTOVILLE GERALDE 0"),cmp);
        if (!e.estCorrecte()) TC.println("ERREUR: liste incorrecte apres deux desistements");
        e.desistement(new Candidat("", "VAUDRUDE SYLVAIN 0"),cmp);
